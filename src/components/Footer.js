      ...
      <Container className='footer-container'>
        <Row>
          ...
          <Col sm={12} md={3} className="mb-4">
            ...
            <ul className="list-unstyled mt-3" style={{position:'relative', right:'50px', paddingRight:'50px'}}>
              <li><a href="#">Home</a></li>
          ...
          <Col sm={12} md={3} className="mb-4">
            ...
            <ul className="list-unstyled mt-3" style={{whiteSpace:'nowrap', position:'relative', right:'50px', paddingRight:'50px' }}>
          ...
          <Col sm={12} md={3} className="mb-4">
            ...
            <ul className="list-unstyled d-flex mt-3" style={{position:'relative', right:'50px'}} >
              <li className="me-1"><a href="#"><FaInstagram size={20} className="text-white" /></a></li>
              <li className="me-1"><a href="#"><FaFacebook size={20} className="text-white" /></a></li>
              <li className='me-1'><a href="#"><FaLinkedin size={20} className="text-white" /></a></li>
              <li className='me-1'><a href="#"><FaYoutube size={20} className="text-white" /></a></li>
            </ul>
          </Col>
        </Row>
      </Container>
